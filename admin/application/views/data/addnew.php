...
<?php $this->view('dashboard/leftbar'); ?>
    ...
    <div class="container-fluid">
        <div class="side-body">
          ...
          <h3 class="text-muted">» Add New Items</h3>
          <hr>
          <div class="row">
            ...
            <div class="col-md-8 col-sm-12 col-xs-12">
               <form method="post" action="<?php echo base_url().'items/save' ?>">
                              <div class="form-group row">
                                <label for="name" class="col-4 col-form-label">Item Names</label> 
                                <div class="col-8">
                                  <input id="nama" name="nama" value="" class="form-control here" type="text">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="lastname" class="col-4 col-form-label">Stock</label> 
                                <div class="col-8">
                                  <input id="lastname" name="stock" value="" class="form-control here" type="text">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="publicinfo" class="col-4 col-form-label">Colour</label> 
                                <div class="col-8">
                                  <input id="website" name="colour" value="" class="form-control here" type="text">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="newpass" class="col-4 col-form-label">Merek</label> 
                                <div class="col-8">
                                  <input id="newpass" name="merek" value="" class="form-control here" type="text">
                                </div>
                              </div> 
                              <div class="form-group row">
                                <label for="website" class="col-4 col-form-label">Image Link</label> 
                                <div class="col-8">
                                  <input id="website" name="link" value="" class="form-control here" type="text">
                                </div>
                              </div>
                              <div class="form-group row">
