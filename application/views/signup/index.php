...
<title>Pertamina | Sign Up Form</title>
...
<style type="text/css">
	body{
		...
		letter-spacing: 2px;
		background-image:url('https://www.pertamina.com/Media/Image/slider/Pertamina_Confident.jpg');
	...
	<div class="col-sm-offset-8 col-sm-4">
		<?php if($this->session->flashdata('success_msg')){ ?>
			<div class="alert alert-success">
				...
				<?php echo $this->session->flashdata('success_msg'); ?><a href="<?php echo base_url('#borrow')?>">Login Now</a>
			</div>
		<?php } ?>
...
<div class="row">
    ...
    <form action="<?php echo base_url('signup/submit') ?>" method="post">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
        	<input type="text" class="form-control" name="hp" placeholder="Nomor HP" required="required">
        </div>
		<div class="form-group">
	...
	<div class="text-center">Already have an account? <a href="<?php echo base_url(); ?>#borrow">Sign in</a></div>
</div>
	</div>
	<div class="col-md-4 col-sm-1 col-xs-1"></div>
</div>
